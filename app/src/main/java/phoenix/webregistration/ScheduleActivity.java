...
public class ScheduleActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Detect orientation -- if portrait, list of classes. Else, calendar fragment
        // Documentation: Returns the rotation of the screen from its "natural" orientation. The
        // returned value may be Surface.ROTATION_0 (no rotation), Surface.ROTATION_90,
        // Surface.ROTATION_180, or Surface.ROTATION_270.
        Display display = ((WindowManager) getBaseContext().
                getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();
        int rotation = display.getRotation();
        if(rotation == Surface.ROTATION_0 || rotation == Surface.ROTATION_180) {    // portrait
        ...
        setContentView(R.layout.schedule_calendar_view);
